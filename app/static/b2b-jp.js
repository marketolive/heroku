...
var b2b = {
  ...
  {"header": "パーソナライゼーション", "description": "Marketoソーシャルマーケティングは、見込顧客、既存顧客が企業のメッセージを知人に簡単に共有できるようサポートしています。最近のForrester調査レポートによると、消費者の70%は友人からのおすすめを信用しますが、広告を信頼する人は10%にしか及びません。", "bp":"49% 0%"},
  {"header": "ソーシャルプロモーション", "description": " Marketoパーソナライゼーションはターゲティングした個人に対して、メール、Web、広告、モバイルを通して、コミュニケーションを動的にパーソナライズさせます。CMSは不要でITチームのサポートなしで実装可能です", "bp":"99% 0%"}
  ],
  section3: [
