...
var b2b = {
	...
	{"header": "リターゲティング", "description": "MarketoAdブリッジはMarketoのリッチな行動データをFacebook,Google,その他の広告プラットフォームと連携させます。マーケターはターゲットとなる入学を検討中の学生に関連性のある広告でターゲティングできるようになります", "bp":"30% 0%"},
	{"header": "ナーチャリング", "description": "Marketoは簡単なウェビナーから学生向けの大規模なイベントまで管理できるプラットフォームを提供し、イベントの開催も最小限の労力で実行可能です", "bp":"63% 0%"},
