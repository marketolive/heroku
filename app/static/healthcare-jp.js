...
var b2b = {
	section2: [
	{"header": "検索の最適化", "description": "Marketo SEOは、マーケターがSEOの専門的な知識がなくても、企業のWebサイト、ランディングページへ質の高いトラッフィク、潜在的な患者を増やすことをサポートします。", "bp":"0% 0%"},
	{"header": "志願者の獲得", "description": "関心を引きつけるランディングページと登録フォームでより多くの患者獲を獲得します", "bp":"50% 0%"},
	{"header": "ソーシャルプロモーション", "description": "Marketoはマーケティング戦略の様々な局面で活用できる統合されたソーシャルマーケティングを提供しています。Marketoは貴社のサービスに関心のある患者を見つけ、長期的な患者へと変化させ関係を維持することをサポートします。", "bp":"100% 0%"}
	],
	section3: [
	{"header": "メールマーケティング", "description": "Marketoのメール機能ならマーケターがベストプラクティスに則って即座にメールによる施策を実行に移すことを可能にします。パーソナライズされた体験を提供することで、潜在顧客や既存患者様とのエンゲージメントをより深いものへ進めることができます", "bp":"0% 0%"},
	{"header": "リターゲティング", "description": "MarketoAdブリッジはMarketoのリッチな行動データをFacebook,Google,その他の広告プラットフォームと連携させます。マーケターはターゲットとなる患者様に関連性のある広告でターゲティングできるようになります", "bp":"30% 0%"},
	{"header": "ナーチャリング", "description": "潜在的な患者様、既存の患者様に向けてメール、Web、モバイル、イベント、ソーシャルメディアなどを含むすべてのチャネルを活用してマーケティングプログラムを効果的に実行、管理します。", "bp":"60% 0%"},
	{"header": "イベント", "description": "Marketoは簡単なウェビナーから大規模なイベントまで管理できるプラットフォームを提供し、イベントの開催も最小限の労力で実行可能です", "bp":"100% 0%"},
	],
	section4: [
	{"header": "患者とのエンゲージメント", "description": "Marketoのエンゲージメントスコアはマーケターがすぐに、かつ簡単にコンテンツのパフォーマンスを測定するための指標です。", "bp":"0% 0%"},
